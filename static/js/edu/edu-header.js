(function () {
  ...
  function quizHeaderHtml(active, subj, type){
    ...
    var itemName = ({zh:{poem:'古诗',zi:'识字',stroke:'笔顺',pinyin:'拼音',yun:'拼音',read:'拼音',tone:'拼音',fan:'词语',liang:'词语',daily:'每日挑战'},
                     ...
                     go:{atari:'基本气与吃子',liberty:'找气与逃跑',capture:'打吃与提子',connect:'连接与分断',life_death:'死活与二眼',ko:'打劫与劫材',semeai:'共活与双活',opening:'布局与定式',endgame:'官子与收官',quiz:'围棋大闯关'}}[subj]||{})[gkey] || type;
